  ...
  return (
    <nav className="fixed top-0 w-full z-50 backdrop-blur-lg bg-white/10 border-b border-white/20">
      ...
      <div className="max-w-7xl mx-auto px-5 py-4 flex justify-between items-center text-white">
        ...
        <h1 className="text-lg sm:text-xl font-bold tracking-wid text-sky-400">
          Paras.dev
        </h1>
        ...
        {["Home", "Projects", "Skills", "Achievements", "Contact"].map((item) => (
            ...
            >
              {item}
              <span
                className="absolute left-0 -bottom-1 h-[2px] w-0 bg-sky-400 transition-all duration-300 group-hover:w-full"
              />
            </a>
          ))}
        </div>
