const projects = [
  ...
  },
  {
    ...
    description:
      "Interactive 3D portfolio website with smooth animations and modern UI for showcasing creative work.",
  ...
  },
  {
    ...
    description:
      "Responsive e-commerce website featuring product listings, categories, and user-friendly shopping experience.",
  ...
  },
  {
    ...
    description:
      "Snake game integrated with an AI agent that learns to play using basic reinforcement learning logic.",
  ...
  },
  {
    ...
    description:
      "Real-time weather application using public API to display current conditions and forecasts.",
  ...
  },
  {
    ...
    description:
      "Task management app with add, edit, delete, and mark-complete functionality.",
